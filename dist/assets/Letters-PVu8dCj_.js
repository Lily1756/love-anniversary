...
</html>`,s=new Blob([o],{type:`text/html;charset=utf-8`}),c=URL.createObjectURL(s);window.open(c,`_blank`)};return C(()=>{f.letters.length===0&&f.loadLetters()}),(n,i)=>(t(),d(`div`,ve,[l(`div`,ye,[l(`div`,be,[l(`h2`,xe,[i[15]||=v(` 情书馆 `,-1),l(`span`,Se,`(`+S(J.value.length)+`)`,1)]),l(`div`,Ce,[s(_)?(t(),d(m,{key:1},[l(`button`,{class:`add-btn`,onClick:X},[...i[17]||=[l(`svg`,{viewBox:`0 0 24 24`,width:`16`,height:`16`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[l(`line`,{x1:`12`,y1:`5`,x2:`12`,y2:`19`}),l(`line`,{x1:`5`,y1:`12`,x2:`19`,y2:`12`})],-1),v(` 写情书 `,-1)]]),l(`button`,{class:`done-btn`,onClick:i[1]||=(...e)=>s(I)&&s(I)(...e)},`完成`)],64)):(t(),d(`button`,{key:0,class:`edit-btn`,onClick:i[0]||=(...e)=>s(P)&&s(P)(...e)},[...i[16]||=[l(`svg`,{viewBox:`0 0 24 24`,width:`16`,height:`16`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[l(`path`,{d:`M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z`})],-1),v(` 编辑 `,-1)]]))])]),l(`div`,we,[l(`div`,Te,[e(l(`select`,{"onUpdate:modelValue":i[2]||=e=>B.value=e,class:`filter-select`},[i[18]||=l(`option`,{value:`all`},`全部年份`,-1),(t(!0),d(m,null,o(s(f).letterYears,e=>(t(),d(`option`,{key:e,value:e},S(e)+`年 `,9,Ee))),128))],512),[[E,B.value]]),l(`div`,De,[e(l(`input`,{"onUpdate:modelValue":i[3]||=e=>H.value=e,type:`text`,placeholder:`搜索情书...`,class:`search-input`},null,512),[[w,H.value]]),i[19]||=l(`svg`,{class:`search-icon`,viewBox:`0 0 24 24`,width:`18`,height:`18`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[l(`circle`,{cx:`11`,cy:`11`,r:`8`}),l(`path`,{d:`M21 21l-4.35-4.35`})],-1)])]),l(`button`,{class:`ebook-btn-sm`,onClick:i[4]||=e=>W.value=!0,disabled:s(f).letterYears.length===0,title:`生成年度电子书`},[...i[20]||=[l(`svg`,{viewBox:`0 0 24 24`,width:`15`,height:`15`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[l(`path`,{d:`M4 19.5A2.5 2.5 0 0 1 6.5 17H20`}),l(`path`,{d:`M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z`})],-1),v(` 电子书 `,-1)]],8,Oe)])]),(t(),g(c,{to:`body`},[W.value?(t(),d(`div`,{key:0,class:`ebook-overlay`,onClick:i[6]||=D(e=>W.value=!1,[`self`])},[l(`div`,ke,[l(`div`,Ae,[i[21]||=l(`span`,null,`📖 选择年份`,-1),l(`button`,{class:`picker-close`,onClick:i[5]||=e=>W.value=!1},`×`)]),l(`div`,je,[(t(!0),d(m,null,o(s(f).letterYears,e=>(t(),d(`button`,{key:e,class:`picker-year-btn`,onClick:t=>{ae(e),W.value=!1}},S(e)+`年 `,9,Me))),128))])])])):x(``,!0)])),p(_e,{letters:s(f).letters,onDateSelected:ne,onMonthSelected:re},null,8,[`letters`]),U.value!==null||B.value!==`all`||V.value!==`all`?(t(),d(`div`,Ne,[U.value===null?(t(),d(`span`,Fe,[i[22]||=v(` 正在查看 `,-1),B.value===`all`?x(``,!0):(t(),d(m,{key:0},[v(S(B.value)+`年`,1)],64)),V.value===`all`?x(``,!0):(t(),d(m,{key:1},[v(S(V.value)+`月`,1)],64)),i[23]||=v(` 的情书 `,-1)])):(t(),d(`span`,Pe,`📅 正在查看 `+S(U.value)+` 的情书`,1)),l(`button`,{class:`clear-filter`,onClick:ie},`清除筛选`)])):x(``,!0),l(`div`,Ie,[(t(!0),d(m,null,o(J.value,e=>(t(),d(`div`,{key:e.id,class:u([`letter-card-wrapper`,{"edit-mode":s(_)}])},[s(_)?(t(),d(`button`,{key:0,class:`delete-btn`,onClick:t=>$(e.id),title:`删除情书`},[...i[24]||=[l(`svg`,{viewBox:`0 0 24 24`,width:`14`,height:`14`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[l(`path`,{d:`M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2`})],-1)]],8,Le)):x(``,!0),p(te,{letter:e,onClick:t=>s(_)?Z(e):Y(e.id)},null,8,[`letter`,`onClick`])],2))),128))]),J.value.length===0?(t(),d(`div`,Re,[U.value===null?B.value!==`all`||V.value!==`all`?(t(),d(`p`,Be,S(B.value===`all`?``:B.value+`年`)+S(V.value===`all`?``:V.value+`月`)+`暂无情书记录 `,1)):(t(),d(`p`,Ve,`暂无情书，写下第一封吧 💌`)):(t(),d(`p`,ze,`这一天还没有情书记录`))])):x(``,!0),p(A,{modelValue:s(b),"onUpdate:modelValue":i[7]||=e=>r(b)?b.value=e:null,password:s(M),error:s(N),"onUpdate:password":i[8]||=e=>M.value=e,onConfirm:s(F)},null,8,[`modelValue`,`password`,`error`,`onConfirm`]),p(O,{modelValue:G.value,"onUpdate:modelValue":i[14]||=e=>G.value=e,title:K.value?`编辑情书`:`写情书`},{footer:h(()=>[l(`button`,{class:`btn-text`,onClick:i[13]||=e=>G.value=!1},`取消`),l(`button`,{class:`btn-primary`,onClick:Q},`保存`)]),default:h(()=>[l(`div`,He,[l(`div`,Ue,[i[25]||=l(`label`,null,`标题`,-1),e(l(`input`,{"onUpdate:modelValue":i[9]||=e=>q.value.title=e,type:`text`,placeholder:`给这封情书起个名字...`,maxlength:`50`},null,512),[[w,q.value.title]])]),l(`div`,We,[i[26]||=l(`label`,null,`日期`,-1),e(l(`input`,{"onUpdate:modelValue":i[10]||=e=>q.value.date=e,type:`date`},null,512),[[w,q.value.date]])]),l(`div`,Ge,[i[27]||=l(`label`,null,`内容`,-1),e(l(`textarea`,{"onUpdate:modelValue":i[11]||=e=>q.value.content=e,rows:`8`,placeholder:`写下你想说的话...`},null,512),[[w,q.value.content]])]),l(`div`,Ke,[i[29]||=l(`label`,null,`标签`,-1),e(l(`select`,{"onUpdate:modelValue":i[12]||=e=>q.value.tag=e},[...i[28]||=[l(`option`,{value:`日常`},`日常`,-1),l(`option`,{value:`纪念日`},`纪念日`,-1),l(`option`,{value:`旅行`},`旅行`,-1),l(`option`,{value:`道歉`},`道歉`,-1),l(`option`,{value:`感谢`},`感谢`,-1)]],512),[[E,q.value.tag]])])])]),_:1},8,[`modelValue`,`title`])]))}}),[[`__scopeId`,`data-v-b735d86d`]]);export{qe as default};