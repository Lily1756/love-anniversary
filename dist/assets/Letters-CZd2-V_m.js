...
</html>`,s=new Blob([o],{type:`text/html;charset=utf-8`}),c=URL.createObjectURL(s);window.open(c,`_blank`)};return C(()=>{f.letters.length===0&&f.loadLetters()}),(n,i)=>(t(),d(`div`,ue,[l(`div`,de,[l(`div`,fe,[l(`h2`,pe,[i[15]||=v(` 情书馆 `,-1),l(`span`,me,`(`+S(K.value.length)+`)`,1)]),l(`div`,he,[s(_)?(t(),d(m,{key:1},[l(`button`,{class:`add-btn`,onClick:J},[...i[17]||=[l(`svg`,{viewBox:`0 0 24 24`,width:`16`,height:`16`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[l(`line`,{x1:`12`,y1:`5`,x2:`12`,y2:`19`}),l(`line`,{x1:`5`,y1:`12`,x2:`19`,y2:`12`})],-1),v(` 写情书 `,-1)]]),l(`button`,{class:`done-btn`,onClick:i[1]||=(...e)=>s(I)&&s(I)(...e)},`完成`)],64)):(t(),d(`button`,{key:0,class:`edit-btn`,onClick:i[0]||=(...e)=>s(P)&&s(P)(...e)},[...i[16]||=[l(`svg`,{viewBox:`0 0 24 24`,width:`16`,height:`16`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[l(`path`,{d:`M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z`})],-1),v(` 编辑 `,-1)]]))])]),l(`div`,ge,[l(`div`,_e,[e(l(`select`,{"onUpdate:modelValue":i[2]||=e=>R.value=e,class:`filter-select`},[i[18]||=l(`option`,{value:`all`},`全部年份`,-1),(t(!0),d(m,null,o(s(f).letterYears,e=>(t(),d(`option`,{key:e,value:e},S(e)+`年 `,9,ve))),128))],512),[[E,R.value]]),l(`div`,ye,[e(l(`input`,{"onUpdate:modelValue":i[3]||=e=>B.value=e,type:`text`,placeholder:`搜索情书...`,class:`search-input`},null,512),[[w,B.value]]),i[19]||=l(`svg`,{class:`search-icon`,viewBox:`0 0 24 24`,width:`18`,height:`18`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[l(`circle`,{cx:`11`,cy:`11`,r:`8`}),l(`path`,{d:`M21 21l-4.35-4.35`})],-1)])]),l(`button`,{class:`ebook-btn-sm`,onClick:i[4]||=e=>H.value=!0,disabled:s(f).letterYears.length===0,title:`生成年度电子书`},[...i[20]||=[l(`svg`,{viewBox:`0 0 24 24`,width:`15`,height:`15`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[l(`path`,{d:`M4 19.5A2.5 2.5 0 0 1 6.5 17H20`}),l(`path`,{d:`M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z`})],-1),v(` 电子书 `,-1)]],8,be)])]),(t(),g(c,{to:`body`},[H.value?(t(),d(`div`,{key:0,class:`ebook-overlay`,onClick:i[6]||=D(e=>H.value=!1,[`self`])},[l(`div`,xe,[l(`div`,Se,[i[21]||=l(`span`,null,`📖 选择年份`,-1),l(`button`,{class:`picker-close`,onClick:i[5]||=e=>H.value=!1},`×`)]),l(`div`,Ce,[(t(!0),d(m,null,o(s(f).letterYears,e=>(t(),d(`button`,{key:e,class:`picker-year-btn`,onClick:t=>{ae(e),H.value=!1}},S(e)+`年 `,9,we))),128))])])])):x(``,!0)])),p(le,{letters:s(f).letters,onDateSelected:Q,onMonthSelected:$},null,8,[`letters`]),V.value!==null||R.value!==`all`||z.value!==`all`?(t(),d(`div`,Te,[V.value===null?(t(),d(`span`,De,[i[22]||=v(` 正在查看 `,-1),R.value===`all`?x(``,!0):(t(),d(m,{key:0},[v(S(R.value)+`年`,1)],64)),z.value===`all`?x(``,!0):(t(),d(m,{key:1},[v(S(z.value)+`月`,1)],64)),i[23]||=v(` 的情书 `,-1)])):(t(),d(`span`,Ee,`📅 正在查看 `+S(V.value)+` 的情书`,1)),l(`button`,{class:`clear-filter`,onClick:ie},`清除筛选`)])):x(``,!0),l(`div`,Oe,[(t(!0),d(m,null,o(K.value,e=>(t(),d(`div`,{key:e.id,class:u([`letter-card-wrapper`,{"edit-mode":s(_)}])},[s(_)?(t(),d(`button`,{key:0,class:`delete-btn`,onClick:t=>Z(e.id),title:`删除情书`},[...i[24]||=[l(`svg`,{viewBox:`0 0 24 24`,width:`14`,height:`14`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[l(`path`,{d:`M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2`})],-1)]],8,ke)):x(``,!0),p(re,{letter:e,onClick:t=>s(_)?Y(e):q(e.id)},null,8,[`letter`,`onClick`])],2))),128))]),K.value.length===0?(t(),d(`div`,Ae,[V.value===null?R.value!==`all`||z.value!==`all`?(t(),d(`p`,Me,S(R.value===`all`?``:R.value+`年`)+S(z.value===`all`?``:z.value+`月`)+`暂无情书记录 `,1)):(t(),d(`p`,Ne,`暂无情书，写下第一封吧 💌`)):(t(),d(`p`,je,`这一天还没有情书记录`))])):x(``,!0),p(A,{modelValue:s(b),"onUpdate:modelValue":i[7]||=e=>r(b)?b.value=e:null,password:s(M),error:s(N),"onUpdate:password":i[8]||=e=>M.value=e,onConfirm:s(F)},null,8,[`modelValue`,`password`,`error`,`onConfirm`]),p(O,{modelValue:U.value,"onUpdate:modelValue":i[14]||=e=>U.value=e,title:W.value?`编辑情书`:`写情书`},{footer:h(()=>[l(`button`,{class:`btn-text`,onClick:i[13]||=e=>U.value=!1},`取消`),l(`button`,{class:`btn-primary`,onClick:X},`保存`)]),default:h(()=>[l(`div`,Pe,[l(`div`,Fe,[i[25]||=l(`label`,null,`标题`,-1),e(l(`input`,{"onUpdate:modelValue":i[9]||=e=>G.value.title=e,type:`text`,placeholder:`给这封情书起个名字...`,maxlength:`50`},null,512),[[w,G.value.title]])]),l(`div`,Ie,[i[26]||=l(`label`,null,`日期`,-1),e(l(`input`,{"onUpdate:modelValue":i[10]||=e=>G.value.date=e,type:`date`},null,512),[[w,G.value.date]])]),l(`div`,Le,[i[27]||=l(`label`,null,`内容`,-1),e(l(`textarea`,{"onUpdate:modelValue":i[11]||=e=>G.value.content=e,rows:`8`,placeholder:`写下你想说的话...`},null,512),[[w,G.value.content]])]),l(`div`,Re,[i[29]||=l(`label`,null,`标签`,-1),e(l(`select`,{"onUpdate:modelValue":i[12]||=e=>G.value.tag=e},[...i[28]||=[l(`option`,{value:`日常`},`日常`,-1),l(`option`,{value:`纪念日`},`纪念日`,-1),l(`option`,{value:`旅行`},`旅行`,-1),l(`option`,{value:`道歉`},`道歉`,-1),l(`option`,{value:`感谢`},`感谢`,-1)]],512),[[E,G.value.tag]])])])]),_:1},8,[`modelValue`,`title`])]))}}),[[`__scopeId`,`data-v-b735d86d`]]);export{ze as default};