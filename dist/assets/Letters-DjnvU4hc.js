...
</html>`}function r(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function i(e,t,r){let i=n(e,t,r),a=new Blob([i],{type:`text/html;charset=utf-8`}),o=URL.createObjectURL(a),s=window.open(o,`_blank`);return setTimeout(()=>URL.revokeObjectURL(o),3e4),s}return{generateYearbookHTML:n,openYearbook:i}}var Ce={class:`letters-page page-container`},we={class:`page-header`},Te={class:`page-title`},Ee={class:`count`},De={class:`header-actions`},Oe={class:`filters`},ke=[`value`],Ae={class:`search-box`},je={key:1,class:`filter-hint`},Me={key:0},Ne={key:1},Pe={class:`letters-grid`},Fe=[`onClick`],Ie={key:3,class:`empty-state`},Le={class:`yearbook-form`},Re={class:`form-group`},ze=[`value`],Be={class:`form-group`},Ve={class:`letter-form`},He={class:`form-group`},Ue={class:`form-group`},We={class:`form-group`},Ge={class:`form-group`},Ke=S(m({__name:`Letters`,setup(e){let r=ee(),s=te(),u=o(`all`),m=o(`all`),y=o(null),S=o(``),{isEditMode:O,showAuth:j,authPassword:M,authError:N,openAuthModal:P,verifyAuth:F,exitEditMode:I}=re({password:`2025`}),{saveStatus:L,saveMessage:R,triggerDebouncedSave:z}=A(),{openYearbook:B}=Se();function V(e){e===null?m.value=`all`:(m.value=String(e),y.value=null,S.value=``)}function ae(e){e===null?y.value=null:(y.value=e,m.value=`all`,S.value=``)}function se(){u.value=`all`,m.value=`all`,y.value=null,S.value=``}let H=o(!1),U=o(new Date().getFullYear()),W=o(`你和我`);function ce(){let e=s.letterYears[0];e!==void 0&&(U.value=e),H.value=!0}function le(e){return s.letters.filter(t=>t.year===e).length}function G(){let e=s.letters.filter(e=>e.year===U.value);if(e.length===0){alert(`该年暂无情书`);return}H.value=!1,B(U.value,e,W.value||`你和我`)}let K=o(!1),q=o(null),J=o({title:``,date:``,tag:``,content:``}),Y=()=>new Date().toISOString().split(`T`)[0]??new Date().toISOString().slice(0,10);function ue(e){e?(q.value=e,J.value={title:e.title,date:e.date,tag:e.tag??``,content:e.content}):(q.value=null,J.value={title:``,date:Y(),tag:``,content:``}),K.value=!0}function de(){if(!J.value.title.trim()||!J.value.content.trim()){alert(`请填写标题和内容`);return}let e={id:q.value?q.value.id:`letter-`+Date.now(),title:J.value.title.trim(),content:J.value.content.trim(),date:J.value.date||Y(),year:new Date(J.value.date||Y()).getFullYear(),tag:J.value.tag.trim()||void 0};if(q.value){let t=s.letters.findIndex(t=>t.id===e.id);t>=0&&(s.letters[t]=e)}else s.letters.unshift(e);K.value=!1,q.value=null,X()}function fe(e){confirm(`确定要删除这封情书吗？`)&&(s.letters=s.letters.filter(t=>t.id!==e),X())}async function X(){z(()=>s.saveLetters(`2025`))}let pe=`我们.一起.这个.那个.然后.因为.所以.可以.已经.还是.没有.不是.只是.但是.如果.知道.觉得.现在.今天.昨天.明天.想要.不会.不能.她的.什么.怎么.这么.真的.非常`.split(`.`),Z=o([]);function Q(){if(s.letters.length===0){Z.value=[];return}let e=s.letters.map(e=>`${e.title} ${e.content}`).join(` `).match(/[\u4e00-\u9fa5]{2,}/g)||[],t={};e.forEach(e=>{t[e]=(t[e]||0)+1}),pe.forEach(e=>{delete t[e]}),Z.value=Object.entries(t).filter(([e])=>e.length>=2).map(([e,t],n)=>({text:e,weight:t,id:s.letters[n%s.letters.length]?.id})).sort((e,t)=>t.weight-e.weight).slice(0,80)}function me(e){let t=document.getElementById(`letter-${e}`);t&&(t.scrollIntoView({behavior:`smooth`,block:`center`}),t.classList.add(`highlight`),setTimeout(()=>t.classList.remove(`highlight`),2e3))}let $=x(()=>{let e=s.letters;if(y.value!==null)return e=e.filter(e=>e.date===y.value),e;if(u.value!==`all`&&(e=e.filter(e=>e.year===Number(u.value))),m.value!==`all`&&(e=e.filter(e=>{let t=e.date.split(`-`);return(t[1]?parseInt(t[1]):0)===Number(m.value)})),S.value.trim()){let t=S.value.toLowerCase();e=e.filter(e=>e.title.toLowerCase().includes(t)||e.content.toLowerCase().includes(t))}return e}),he=e=>{r.push(`/letters/${e}`)};return T(()=>{s.letters.length===0&&s.loadLetters(),Q()}),i(()=>s.letters,()=>{Q()},{deep:!0}),(e,r)=>(n(),p(`div`,Ce,[d(`div`,we,[d(`h2`,Te,[r[17]||=b(` 情书馆 `,-1),d(`span`,Ee,`(`+w($.value.length)+`)`,1)]),d(`div`,De,[d(`div`,Oe,[t(d(`select`,{"onUpdate:modelValue":r[0]||=e=>u.value=e,class:`filter-select`},[r[18]||=d(`option`,{value:`all`},`全部年份`,-1),(n(!0),p(g,null,c(l(s).letterYears,e=>(n(),p(`option`,{key:e,value:e},w(e)+`年 `,9,ke))),128))],512),[[D,u.value]]),d(`div`,Ae,[t(d(`input`,{"onUpdate:modelValue":r[1]||=e=>S.value=e,type:`text`,placeholder:`搜索情书...`,class:`search-input`},null,512),[[E,S.value]]),r[19]||=d(`svg`,{class:`search-icon`,viewBox:`0 0 24 24`,width:`18`,height:`18`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[d(`circle`,{cx:`11`,cy:`11`,r:`8`}),d(`path`,{d:`M21 21l-4.35-4.35`})],-1)])]),l(O)?C(``,!0):(n(),p(`button`,{key:0,class:`yearbook-btn`,onClick:ce},[...r[20]||=[d(`svg`,{viewBox:`0 0 24 24`,width:`16`,height:`16`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[d(`path`,{d:`M4 19.5A2.5 2.5 0 0 1 6.5 17H20`}),d(`path`,{d:`M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z`})],-1),b(` 电子书 `,-1)]])),l(O)?(n(),p(g,{key:2},[d(`button`,{class:`add-btn`,onClick:r[3]||=e=>ue()},[...r[22]||=[d(`svg`,{viewBox:`0 0 24 24`,width:`16`,height:`16`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[d(`path`,{d:`M12 5v14M5 12h14`})],-1),b(` 情书 `,-1)]]),d(`button`,{class:`done-btn`,onClick:r[4]||=(...e)=>l(I)&&l(I)(...e)},`完成`)],64)):(n(),p(`button`,{key:1,class:`edit-btn`,onClick:r[2]||=(...e)=>l(P)&&l(P)(...e)},[...r[21]||=[d(`svg`,{viewBox:`0 0 24 24`,width:`16`,height:`16`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[d(`path`,{d:`M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z`})],-1),b(` 编辑 `,-1)]]))])]),h(ye,{letters:l(s).letters,onMonthSelected:V,onDateSelected:ae},null,8,[`letters`]),Z.value.length>0?(n(),v(xe,{key:0,words:Z.value,onWordClick:me},null,8,[`words`])):C(``,!0),y.value!==null||u.value!==`all`||m.value!==`all`?(n(),p(`div`,je,[y.value===null?(n(),p(`span`,Ne,[r[23]||=b(` 正在查看 `,-1),u.value===`all`?C(``,!0):(n(),p(g,{key:0},[b(w(u.value)+`年`,1)],64)),m.value===`all`?C(``,!0):(n(),p(g,{key:1},[b(w(m.value)+`月`,1)],64)),r[24]||=b(` 的情书 `,-1)])):(n(),p(`span`,Me,`📅 正在查看 `+w(y.value)+` 的情书`,1)),d(`button`,{class:`clear-filter`,onClick:se},`清除筛选`)])):C(``,!0),l(L)===`idle`?C(``,!0):(n(),p(`div`,{key:2,class:f([`save-toast`,l(L)])},[d(`span`,null,w(l(R)),1)],2)),d(`div`,Pe,[(n(!0),p(g,null,c($.value,e=>(n(),p(`div`,{key:e.id,class:f([`letter-card-wrapper`,{"edit-mode":l(O)}])},[h(oe,{letter:e,onClick:t=>!l(O)&&he(e.id)},null,8,[`letter`,`onClick`]),l(O)?(n(),p(`button`,{key:0,class:`delete-letter-btn`,onClick:ne(t=>fe(e.id),[`stop`])},[...r[25]||=[d(`svg`,{viewBox:`0 0 24 24`,width:`14`,height:`14`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[d(`path`,{d:`M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2`})],-1)]],8,Fe)):C(``,!0)],2))),128))]),$.value.length===0?(n(),p(`div`,Ie,[...r[26]||=[d(`p`,null,`暂无情书，写下第一封吧 💌`,-1)]])):C(``,!0),h(ie,{modelValue:l(j),"onUpdate:modelValue":r[5]||=e=>a(j)?j.value=e:null,password:l(M),error:l(N),"onUpdate:password":r[6]||=e=>M.value=e,onConfirm:l(F)},null,8,[`modelValue`,`password`,`error`,`onConfirm`]),h(k,{modelValue:H.value,"onUpdate:modelValue":r[10]||=e=>H.value=e,title:`生成年度电子书`},{footer:_(()=>[d(`button`,{class:`btn-text`,onClick:r[9]||=e=>H.value=!1},`取消`),d(`button`,{class:`btn-primary`,onClick:G},`生成并预览`)]),default:_(()=>[d(`div`,Le,[r[29]||=d(`p`,{class:`yearbook-desc`},`将该年所有情书生成精美的电子书，可在浏览器中直接保存为 PDF 💌`,-1),d(`div`,Re,[r[27]||=d(`label`,null,`选择年份`,-1),t(d(`select`,{"onUpdate:modelValue":r[7]||=e=>U.value=e,class:`filter-select`,style:{width:`100%`}},[(n(!0),p(g,null,c(l(s).letterYears,e=>(n(),p(`option`,{key:e,value:e},w(e)+`年（`+w(le(e))+`封）`,9,ze))),128))],512),[[D,U.value]])]),d(`div`,Be,[r[28]||=d(`label`,null,`署名`,-1),t(d(`input`,{"onUpdate:modelValue":r[8]||=e=>W.value=e,type:`text`,placeholder:`例如：你和我 / 志浩和小丽`},null,512),[[E,W.value]])])])]),_:1},8,[`modelValue`]),h(k,{modelValue:K.value,"onUpdate:modelValue":r[16]||=e=>K.value=e,title:q.value?`编辑情书`:`写一封情书`},{footer:_(()=>[d(`button`,{class:`btn-text`,onClick:r[15]||=e=>K.value=!1},`取消`),d(`button`,{class:`btn-primary`,onClick:de},`保存`)]),default:_(()=>[d(`div`,Ve,[d(`div`,He,[r[30]||=d(`label`,null,`标题`,-1),t(d(`input`,{"onUpdate:modelValue":r[11]||=e=>J.value.title=e,type:`text`,placeholder:`给亲爱的你...`},null,512),[[E,J.value.title]])]),d(`div`,Ue,[r[31]||=d(`label`,null,`日期`,-1),t(d(`input`,{"onUpdate:modelValue":r[12]||=e=>J.value.date=e,type:`date`},null,512),[[E,J.value.date]])]),d(`div`,We,[r[32]||=d(`label`,null,`标签`,-1),t(d(`input`,{"onUpdate:modelValue":r[13]||=e=>J.value.tag=e,type:`text`,placeholder:`例如：纪念日、日常...`},null,512),[[E,J.value.tag]])]),d(`div`,Ge,[r[33]||=d(`label`,null,`内容`,-1),t(d(`textarea`,{"onUpdate:modelValue":r[14]||=e=>J.value.content=e,rows:`8`,placeholder:`写下想说的话...`},null,512),[[E,J.value.content]])])])]),_:1},8,[`modelValue`,`title`])]))}}),[[`__scopeId`,`data-v-abf1d89e`]]);export{Ke as default};